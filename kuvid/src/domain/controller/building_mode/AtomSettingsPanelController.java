...
public class AtomSettingsPanelController implements ChangeListener {
    ...
    public AtomSettingsPanelController(JLabel alphaValueLabel, JLabel betaValueLabel,
